...
<main class="main">
    <div class="page-404-container">
      <div class="page-404-coll-block left-block">
        <svg version="1.1" xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink" viewBox="0 0 800 600" style="visibility: visible;">
          <g>
            ...
            <g id="planet" transform="matrix(0.9996,-0.0289,0.0289,0.9996,-2.9172,16.4574)" style="transform-origin: 0px 0px;">
              <circle fill="none" stroke="#0E0620" stroke-width="3" stroke-miterlimit="10" cx="572.859" cy="108.803" r="90.788"></circle>

              <circle id="craterBig" fill="none" stroke="#0E0620" stroke-width="3" stroke-miterlimit="10" cx="548.891" cy="62.319" r="13.074" transform="matrix(1,0,0,1,2.484,0)" style="transform-origin: 0px 0px;"></circle>

              <circle id="craterSmall" fill="none" stroke="#0E0620" stroke-width="3" stroke-miterlimit="10" cx="591.743" cy="158.918" r="7.989" transform="matrix(1,0,0,1,-2.484,0)" style="transform-origin: 0px 0px;"></circle>
            ...
            <g id="stars">
              <g id="starsBig">
                <g transform="matrix(0.9859,-0.1676,0.1676,0.9859,-35.5971,90.4377)" style="transform-origin: 0px 0px;">
                ...
                <g transform="matrix(0.9785,-0.2061,0.2061,0.9785,-46.5523,37.0555)" style="transform-origin: 0px 0px;">
                ...
                <g transform="matrix(0.9754,-0.2205,0.2205,0.9754,-23.7331,74.116)" style="transform-origin: 0px 0px;">
                ...
                <g transform="matrix(0.9815,-0.1913,0.1913,0.9815,-90.7349,47.522)" style="transform-origin: 0px 0px;">
              ...
              <g id="starsSmall">
                ...
                <g transform="matrix(0.979,0,0,0.9793,5.1247,11.4206)" style="transform-origin: 0px 0px;">
                ...
                <g transform="matrix(0.881,0,0,0.8817,22.1767,48.6386)" style="transform-origin: 0px 0px;">
                ...
                <g transform="matrix(0.704,0,0,0.7041,142.1678,121.6582)" style="transform-origin: 0px 0px;">
              ...
              <g id="circlesBig">
                ...
                <circle fill="none" stroke="#0E0620" stroke-width="3" stroke-linecap="round" stroke-miterlimit="10" cx="588.977" cy="255.978" r="7.952" transform="matrix(1,0,0,1,0,-1.656)" style="transform-origin: 0px 0px;"></circle>

                <circle fill="none" stroke="#0E0620" stroke-width="3" stroke-linecap="round" stroke-miterlimit="10" cx="450.066" cy="320.259" r="7.952" transform="matrix(1,0,0,1,0,-1.656)" style="transform-origin: 0px 0px;"></circle>

                <circle fill="none" stroke="#0E0620" stroke-width="3" stroke-linecap="round" stroke-miterlimit="10" cx="168.303" cy="353.753" r="7.952" transform="matrix(1,0,0,1,0,-1.656)" style="transform-origin: 0px 0px;"></circle>

                <circle fill="none" stroke="#0E0620" stroke-width="3" stroke-linecap="round" stroke-miterlimit="10" cx="429.522" cy="201.185" r="7.952" transform="matrix(1,0,0,1,0,-1.656)" style="transform-origin: 0px 0px;"></circle>

                <circle fill="none" stroke="#0E0620" stroke-width="3" stroke-linecap="round" stroke-miterlimit="10" cx="200.67" cy="176.313" r="7.952" transform="matrix(1,0,0,1,0,-1.656)" style="transform-origin: 0px 0px;"></circle>

                <circle fill="none" stroke="#0E0620" stroke-width="3" stroke-linecap="round" stroke-miterlimit="10" cx="133.343" cy="477.014" r="7.952" transform="matrix(1,0,0,1,0,-1.656)" style="transform-origin: 0px 0px;"></circle>

                <circle fill="none" stroke="#0E0620" stroke-width="3" stroke-linecap="round" stroke-miterlimit="10" cx="283.521" cy="568.033" r="7.952" transform="matrix(1,0,0,1,0,-1.656)" style="transform-origin: 0px 0px;"></circle>

                <circle fill="none" stroke="#0E0620" stroke-width="3" stroke-linecap="round" stroke-miterlimit="10" cx="413.618" cy="482.387" r="7.952" transform="matrix(1,0,0,1,0,-1.656)" style="transform-origin: 0px 0px;"></circle>
              </g>
              <g id="circlesSmall">
                <circle fill="#0E0620" cx="549.879" cy="296.402" r="2.651" transform="matrix(1,0,0,1,0,-3.313)" style="transform-origin: 0px 0px;"></circle>
                <circle fill="#0E0620" cx="253.29" cy="229.24" r="2.651" transform="matrix(1,0,0,1,0,-3.313)" style="transform-origin: 0px 0px;"></circle>
                <circle fill="#0E0620" cx="434.824" cy="263.931" r="2.651" transform="matrix(1,0,0,1,0,-3.313)" style="transform-origin: 0px 0px;"></circle>
                <circle fill="#0E0620" cx="183.708" cy="544.176" r="2.651" transform="matrix(1,0,0,1,0,-3.313)" style="transform-origin: 0px 0px;"></circle>
                <circle fill="#0E0620" cx="382.515" cy="530.923" r="2.651" transform="matrix(1,0,0,1,0,-3.313)" style="transform-origin: 0px 0px;"></circle>
                <circle fill="#0E0620" cx="130.693" cy="305.608" r="2.651" transform="matrix(1,0,0,1,0,-3.313)" style="transform-origin: 0px 0px;"></circle>
                <circle fill="#0E0620" cx="480.296" cy="477.014" r="2.651" transform="matrix(1,0,0,1,0,-3.313)" style="transform-origin: 0px 0px;"></circle>
              </g>
            </g>
            <g id="spaceman" clip-path="url(cordClip)" transform="matrix(0.9999,0.0145,-0.0145,0.9999,3.1991,1.1944)" style="transform-origin: 0px 0px;">
			...
			C360.647,451.083,349.251,457.661,338.164,454.689z"></path>
              ...
              <g id="head">
				...
				M330.868,261.338c-7.929,1.72-15.381,5.246-21.799,10.246" transform="matrix(0.9999,0.0145,-0.0145,0.9999,3.8203,-4.0414)" style="transform-origin: 0px 0px;"></path>
      ...
      <div class="page-404-coll-block right-block">
        <h1>404</h1>
