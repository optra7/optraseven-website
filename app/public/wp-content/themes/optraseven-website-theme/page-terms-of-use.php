            ...
            <div class="container">
                <div class="o7-hero-legal__header-content">
                    ...
                    <h2 class="o7-hero-legal__subtitle">
                        The OptraSeven website located at www.optraseven.com is a copyrighted work belonging to
                        OptraSeven LLC. Certain features of the Site may be subject to additional guidelines, terms,
            ...
            <div class="container o7-stepper-wrapper">
                ...
                <aside class="o7-stepper__sidebar">
                    <ul class="o7-stepper__nav">
                        ...
                        <li class="o7-stepper__nav-item" tabindex="0">
                            <a href="#limitation-on-liability">
                                <span class="o7-stepper__nav-bullet o7-stepper__nav-bullet--white"></span>
                                Limitation on Liability
                            </a>
                        </li>
                        <li class="o7-stepper__nav-item" tabindex="0">
                            <a href="#automatically-collected-information">
                                <span class="o7-stepper__nav-bullet o7-stepper__nav-bullet--white"></span>
                ...
                <div class="o7-stepper__article-wrapper">
                    <article class="o7-stepper-article">
                        ...
                        <p class="o7-stepper-article__para">
                            ...
                            names, access times and referring website addresses. This information is used for
                            the operation of the service, to maintain quality of the service, and to provide
                            general statistics regarding use of the Outliant website.
                        </p>

                        <h2 class="o7-stepper-article__para-title" id="copyright-policy">
                            Copyright Policy
                        </h2>
                        <p class="o7-stepper-article__para">
                        ...
                        <ul class="o7-stepper-article__list">
                            ...
                            <li class="o7-stepper-article__list-item">identification of the material on our services
                                that
                                you claim is infringing and that
