...
<section class="section">
    <div class="container">
        <div class="o7-map-container">
            <svg class="o7-map__world-map" xmlns="http://www.w3.org/2000/svg" width="660" height="320"
                viewBox="0 0 201 97">
                <g fill="#787878" style="fill:#787878 !important;">
            ...
            <div class="o7-map__card-bangladesh">
                <div class="o7-map__office-location">
                    <div class="o7-map__office-location-1st-circle o7-map-pin">
                        <div class="o7-map__office-location-2nd-circle">
